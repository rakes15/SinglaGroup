 ...
 */
public class CompanyFilterableAdapter extends BaseAdapter implements Filterable {

    private Context context;
    private static LayoutInflater inflater=null;
    List<Map<String,String>> data=null;
    List<Map<String,String>> data2=null;
    public CompanyFilterableAdapter(Context context, List<Map<String,String>> data, List<Map<String,String>> data2) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (dataset != null) {
            ...
            if (customerNameLabel != null) {
                customerNameLabel.setTag(dataset.get("CompanyID"));
                customerNameLabel.setText(dataset.get("CompanyName"));
            }
        }
        return convertView;
    }
        ...
        return new android.widget.Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                for(int i = 0; i<data.size(); i++){
                    ...
                    String DocNo = searchdata.get("CompanyName");
