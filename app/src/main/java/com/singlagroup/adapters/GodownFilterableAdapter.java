 ...
 */
public class GodownFilterableAdapter extends BaseAdapter implements Filterable {

    private Context context;
    private static LayoutInflater inflater=null;
    List<GodownDataset> data=null;
    List<GodownDataset> data2=null;
    public GodownFilterableAdapter(Context context, List<GodownDataset> data, List<GodownDataset> data2) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        txt.setText(data.get(position).getGodownName());
        if(position == 0){
    ...
    public android.widget.Filter getFilter() {
        ...
        return new android.widget.Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                List<GodownDataset> Filtered_Names = new ArrayList<GodownDataset>();
                String filterString = constraint.toString().toLowerCase();
                String filterableString;

                for(int i = 0; i<data.size(); i++){
                    GodownDataset searchdata = data.get(i);
                    String DocNo = searchdata.getGodownName();
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                if (results != null) {
                    if (results.count > 0) {
                        data = new ArrayList<GodownDataset>((List<GodownDataset>) results.values) ;
                    }
                    else
                    {
                        data = new ArrayList<GodownDataset>() ;
                    }
                }
