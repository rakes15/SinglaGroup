 ...
 */
public class UserInfoDataset implements Serializable {
    ...
    private String Msg;
    public UserInfoDataset(int RequestStatus, int AllowUser, int AutoLogIN, String DeviceID, String DefaultUser, String Password, String APIUrl, String AppDownloadLink, String Msg) {
