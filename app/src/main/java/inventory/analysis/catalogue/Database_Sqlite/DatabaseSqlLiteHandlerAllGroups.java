...
public class DatabaseSqlLiteHandlerAllGroups extends SQLiteOpenHelper {
    ...
    //TODO: Database Name
    private static final String DATABASE_NAME = "AllCategory";
    //TODo: Table Name
    ...
    private static final String SINGLA_PARENT_ID = "parentID";
    private static final String SINGLA_PARENT_NAME = "parentName";
    private static final String SINGLA_PARENT_IMAGE_PATH = "parentImagePath";
    ...
    private static final String SINGLA_SUB_GROUP_ID = "subgroupID";
    private static final String SINGLA_SUB_GROUP_NAME = "subgroupName";
    private static final String SINGLA_SUB_GROUP_IMAGE_PATH = "subgroupImagePath";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_GROUPS = "CREATE TABLE " + SINGLA_GROUPS_TABLE + "(" + SINGLA_KEY_ID + " INTEGER PRIMARY KEY," + SINGLA_PARENT_ID + " TEXT," + SINGLA_PARENT_NAME + " TEXT," + SINGLA_PARENT_IMAGE_PATH + " TEXT," + SINGLA_MAIN_GROUP_ID + " TEXT," + SINGLA_MAIN_GROUP_NAME + " TEXT," + SINGLA_MAIN_GROUP_SEQUENCE + " INTEGER," + SINGLA_GROUP_ID + " TEXT," + SINGLA_GROUP_NAME + " TEXT," + SINGLA_GROUP_IMAGE_PATH + " TEXT," + SINGLA_SUB_GROUP_ID + " TEXT," + SINGLA_SUB_GROUP_NAME + " TEXT," + SINGLA_SUB_GROUP_IMAGE_PATH + " TEXT) ";
    ...
    public void insertGroupsTables(List<Map<String,String>> list) {
        ...
        final int ParentID = ih.getColumnIndex(SINGLA_PARENT_ID);
        final int Parent = ih.getColumnIndex(SINGLA_PARENT_NAME);
        final int ParentIcon = ih.getColumnIndex(SINGLA_PARENT_IMAGE_PATH);
        ...
        final int SubGroupID = ih.getColumnIndex(SINGLA_SUB_GROUP_ID);
        final int SubGroup = ih.getColumnIndex(SINGLA_SUB_GROUP_NAME);
        final int SubGroupIcon = ih.getColumnIndex(SINGLA_SUB_GROUP_IMAGE_PATH);
        try {
            ...
            for(int x=0; x<list.size(); x++){
                ...
                ih.bind(ParentID, list.get(x).get("ParentID"));
                ih.bind(Parent, list.get(x).get("Parent"));
                ih.bind(ParentIcon, list.get(x).get("ParentIcon"));
                ...
                ih.bind(SubGroupIcon, list.get(x).get("SubGroupIcon"));
    ...
    public List<RecyclerGroupDataset> getParentList(){
        List<RecyclerGroupDataset> dataList=new ArrayList<>();
        // Select All Query
        String selectQuery = "SELECT DISTINCT("+SINGLA_PARENT_ID+"), "+SINGLA_PARENT_NAME+","+SINGLA_PARENT_IMAGE_PATH+" from " + SINGLA_GROUPS_TABLE+" ORDER BY "+SINGLA_PARENT_NAME+ " ASC";
        ...
        if(cursor.getCount()>0)
        {
            cursor.moveToFirst();
            do {
                dataList.add(new RecyclerGroupDataset(cursor.getString(cursor.getColumnIndex(SINGLA_PARENT_ID)),cursor.getString(cursor.getColumnIndex(SINGLA_PARENT_NAME)),cursor.getString(cursor.getColumnIndex(SINGLA_PARENT_IMAGE_PATH))));
    ...
    public List<Map<String,String>> getMainGroup(String ParentID){
        List<Map<String,String>> dataList=new ArrayList<Map<String,String>>();
        // Select All Query
        String selectQuery = "SELECT DISTINCT "+SINGLA_MAIN_GROUP_ID+" , "+SINGLA_MAIN_GROUP_NAME+" from " + SINGLA_GROUPS_TABLE+" WHERE "+SINGLA_PARENT_ID+"='"+ParentID+"' ORDER BY "+SINGLA_MAIN_GROUP_SEQUENCE;
        //System.out.println(selectQuery);
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery,null);
        // looping through all rows and adding to list
    ...
    public List<RecyclerGroupDataset> getSubGroupList(String GroupID){
        List<RecyclerGroupDataset> dataList=new ArrayList<>();
        // Select All Query
        String selectQuery = "SELECT DISTINCT "+SINGLA_SUB_GROUP_ID+" , "+SINGLA_SUB_GROUP_NAME+", "+SINGLA_SUB_GROUP_IMAGE_PATH+" from " + SINGLA_GROUPS_TABLE+" WHERE "+SINGLA_GROUP_ID+"='"+GroupID+"' ORDER BY "+SINGLA_SUB_GROUP_NAME;
        //System.out.println(selectQuery);
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery,null);
        // looping through all rows and adding to list
        if(cursor.getCount()>0)
        {
            cursor.moveToFirst();
            do {
                dataList.add(new RecyclerGroupDataset(cursor.getString(cursor.getColumnIndex(SINGLA_SUB_GROUP_ID)),cursor.getString(cursor.getColumnIndex(SINGLA_SUB_GROUP_NAME)),cursor.getString(cursor.getColumnIndex(SINGLA_SUB_GROUP_IMAGE_PATH))));
            } while (cursor.moveToNext());
            // closing connection
            cursor.close();
            db.close();
