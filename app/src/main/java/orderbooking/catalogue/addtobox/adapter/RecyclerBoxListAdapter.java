...
//                context.startActivity(intent);
    ...
    private void CallRetrofit(String AKey, String pwd, final String ItemID, String SubItemID, final String ColorID, String SizeID, int flag, final int pos){
        ...
        if (flag==0) {
            Call<ResponseRemoveToBoxDataset> call = apiService.RemoveItemFromCart(params);
                    ...
                    try {
                        if (response.isSuccessful()) {
                            ...
                            if (Status == 1) {
                                ...
                                Utils.setBadgeCount(context, CatalogueActivity.iconBox, StaticValues.totalBoxCount);
                            } else {
            ...
            Call<ResponseMoveToWishlistDataset> call = apiService.MoveToWishList(params);
