...
import orderbooking.customerlist.adapter.ChangePartySelectSubCustomerForOrderAdapter;
...
public class ChangePartySelectSubCustomerForOrderActivity extends AppCompatActivity {
    ActionBar actionBar;
    private Context context;
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private ChangePartySelectSubCustomerForOrderAdapter adapter;
    private ProgressDialog progressDialog;
    private DatabaseSqlLiteHandlerUserInfo DBHandler;
    private String PartyID="",PartyName="";
    private int MultiOrder = 0;
    private static String TAG = ChangePartySelectSubCustomerForOrderActivity.class.getSimpleName();
    @Override
    ...
    private void Initialization(){
        this.context = ChangePartySelectSubCustomerForOrderActivity.this;
    ...
    private void CallApiMethod(){
        ...
        if (!status.contentEquals("No Internet Connection")) {
            ...
            String[] str = obj.GetSharePreferenceSession(ChangePartySelectSubCustomerForOrderActivity.this);
            if (str!=null) {
                CallVolleySelectSubCustomerForOrder(str[2], str[3], str[4], str[0], str[16], str[5],str[14],PartyID);
            }
        } else {
            MessageDialog messageDialog=new MessageDialog();
            messageDialog.MessageDialog(ChangePartySelectSubCustomerForOrderActivity.this,"","","No Internet Connection");
        }
        ...
        NetworkChangeReceiver.bindNetworkListener(new NetworkListener() {
            ...
            public void networkReceived(String status) {
                if (!status.contentEquals("No Internet Connection")) {
                    ...
                    MessageDialog messageDialog=new MessageDialog();
                    messageDialog.MessageDialog(ChangePartySelectSubCustomerForOrderActivity.this,"","",status);
                }
            }
        });
    }
                ...
                try{
                    ...
                    if (Status == 1) {
                        ...
                        for (int i=0; i< jsonArrayScfo.length(); i++){
                            ...
                            map.put("SubPartyID",jsonArrayScfo.getJSONObject(i).getString("SubPartyID"));
                            map.put("SubPartyName",jsonArrayScfo.getJSONObject(i).getString("SubPartyName"));
                            map.put("SubPartyCode",jsonArrayScfo.getJSONObject(i).getString("SubPartyCode"));
                            ...
                            map.put("Address1",jsonArrayScfo.getJSONObject(i).getString("Address1"));
                            map.put("Address2",jsonArrayScfo.getJSONObject(i).getString("Address2"));
                        ...
                        DBChangeParty.deleteChangeSubPartyNEW();
                        DBChangeParty.insertChangeSubPartyNewData(mapList);
                        adapter=new ChangePartySelectSubCustomerForOrderAdapter(context,DBChangeParty.getSubPartyList());
