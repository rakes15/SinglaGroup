...
public class CloseOrdersActivity extends AppCompatActivity {
    ActionBar actionBar;
    ...
    private static String TAG = CloseOrdersActivity.class.getSimpleName();
    @Override
    ...
    private void Initialization(){
        StaticValues.PushOrderFlag = 1;
        StaticValues.AdvanceOrBookOrder = 0;
        StaticValues.BookType = 0;
        this.context = CloseOrdersActivity.this;
    ...
    private void ModulePermission(){
        try {
            ...
            if (StaticValues.viewFlag == 1 || StaticValues.editFlag == 1 || StaticValues.createFlag == 1 || StaticValues.removeFlag == 1 || StaticValues.printFlag == 1 || StaticValues.importFlag == 1 || StaticValues.exportFlag == 1){
                ...
                MessageDialog.MessageDialog(CloseOrdersActivity.this,"Alert","You don't have permission of "+Title+" module");
            }
        }catch (Exception e){
            MessageDialog.MessageDialog(CloseOrdersActivity.this,"Exception",e.toString());
        }
    }
        ...
        NetworkChangeReceiver.bindNetworkListener(new NetworkListener() {
            ...
            public void networkReceived(String status) {
                if (!status.contentEquals("No Internet Connection")) {
                    ...
                    String[] str = obj.GetSharePreferenceSession(CloseOrdersActivity.this);
                    if (str!=null) {
                        CallVolleyCloseOrder(str[2], str[3], str[4], str[0], str[16], str[5],str[14],str[15]);
                    }
                } else {
                    MessageDialog messageDialog=new MessageDialog();
                    messageDialog.MessageDialog(CloseOrdersActivity.this,"","",status);
                }
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    if (Status == 1) {
                        ...
                        List<CloseOrBookDataset> list = new ArrayList<>();
                        ...
                        adapter = new CloseOrderAdapter(items,context);
