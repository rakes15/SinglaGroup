...
public class SelectSubCustomerForOrderActivity extends AppCompatActivity {
    ActionBar actionBar;
    ...
    private static String TAG = SelectSubCustomerForOrderActivity.class.getSimpleName();
    @Override
    ...
    private void Initialization(){
        this.context = SelectSubCustomerForOrderActivity.this;
    ...
    private void ModulePermission(){
        try {
            ...
            if (StaticValues.viewFlag == 1 || StaticValues.editFlag == 1 || StaticValues.createFlag == 1 || StaticValues.removeFlag == 1 || StaticValues.printFlag == 1 || StaticValues.importFlag == 1 || StaticValues.exportFlag == 1){
                ...
                MessageDialog.MessageDialog(SelectSubCustomerForOrderActivity.this,"Alert","You don't have permission of "+Title+" module");
            }
        }catch (Exception e){
            MessageDialog.MessageDialog(SelectSubCustomerForOrderActivity.this,"Exception",e.toString());
        }
    }
    private void CallApiMethod(){
        ...
        if (!status.contentEquals("No Internet Connection")) {
            ...
            String[] str = obj.GetSharePreferenceSession(SelectSubCustomerForOrderActivity.this);
            if (str!=null) {
                CallVolleySelectSubCustomerForOrder(str[2], str[3], str[4], str[0], str[16], str[5],str[14],PartyID);
            }
        } else {
            MessageDialog messageDialog=new MessageDialog();
            messageDialog.MessageDialog(SelectSubCustomerForOrderActivity.this,"","","No Internet Connection");
        }
        ...
        NetworkChangeReceiver.bindNetworkListener(new NetworkListener() {
            ...
            public void networkReceived(String status) {
                if (!status.contentEquals("No Internet Connection")) {
                    ...
                    MessageDialog messageDialog=new MessageDialog();
                    messageDialog.MessageDialog(SelectSubCustomerForOrderActivity.this,"","",status);
                }
            }
        });
    }
