 ...
 */
public class MoreContactInfoAdapter extends RecyclerView.Adapter<MoreContactInfoAdapter.RecyclerViewHolder>{
    ...
    private List<PartyCompleteInfo.ContactInfo>  PartyMoreContactInfoList,filterPartyMoreContactInfoList;
    private List<PartyCompleteInfo.PendingOrderInfo>  PendingOrderInfoList,filterPendingOrderInfoList;
    private static String TAG = MoreContactInfoAdapter.class.getSimpleName();
    public MoreContactInfoAdapter(Context context, String Title , PartyCompleteInfo.Result result) {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
        ...
        if (Title.equals("More Contacts")){
            PartyCompleteInfo.ContactInfo dataset = filterPartyMoreContactInfoList.get(position);
            holder.cardView.setTag(dataset);
            //TODO: call TableLayout method
            setTableLayoutParty(dataset, holder.tableLayout);
        }else if (Title.equals("Pending Orders")){
            PartyCompleteInfo.PendingOrderInfo dataset = filterPendingOrderInfoList.get(position);
            holder.cardView.setTag(dataset);
            //TODO: call TableLayout method
            ...
            public void run() {
                ...
                if (Title.equals("More Contacts")){
                    ...
                    if (TextUtils.isEmpty(text)) {
                        ...
                        for (PartyCompleteInfo.ContactInfo item : PartyMoreContactInfoList) {
                    ...
                    if (TextUtils.isEmpty(text)) {
                        ...
                        // Iterate in the original List and add it to filter list...
                        for (PartyCompleteInfo.PendingOrderInfo item : PendingOrderInfoList) {
    ...
    private void setTableLayoutParty(PartyCompleteInfo.ContactInfo dataset, TableLayout tableLayout){
    ...
    //TODO: Display Party TableLayout
    private void setTableLayoutSubParty(PartyCompleteInfo.PendingOrderInfo dataset, TableLayout tableLayout){
