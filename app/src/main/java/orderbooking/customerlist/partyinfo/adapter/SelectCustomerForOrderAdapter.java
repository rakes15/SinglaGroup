...
import orderbooking.customerlist.partyinfo.MainActivity;
import orderbooking.customerlist.partyinfo.PartyInfoActivity;
import orderbooking.customerlist.partyinfo.PartyInfoSelectSubCustomerForOrderActivity;
 ...
 */
public class SelectCustomerForOrderAdapter extends RecyclerView.Adapter<SelectCustomerForOrderAdapter.RecyclerViewHolder>{
    ...
    private static String TAG = SelectCustomerForOrderAdapter.class.getSimpleName();
    public SelectCustomerForOrderAdapter(Context context, List<SelectCustomerForOrderDataset> datasetList) {
    ...
    //TODO: Party or SubParty Selection Dialog
    private void DialogPartyOrSubPartySelection(final Context context, final SelectCustomerForOrderDataset dataset){
        ...
        txtViewTitle.setText("Party or SubParty");
        ...
        radioGroupPlayOrLocalStore.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                if(radioGroup.getCheckedRadioButtonId()==R.id.RadioButton_NewUser){
                    ...
                    dialog.dismiss();
                    //TODO: SubParty
                    Intent intent = new Intent(context, PartyInfoSelectSubCustomerForOrderActivity.class);
                    intent.putExtra("PartyID", dataset.getPartyID());
