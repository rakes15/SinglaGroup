 ...
 */
public class SubPartyCommonDetailsListAdapter extends RecyclerView.Adapter<SubPartyCommonDetailsListAdapter.RecyclerViewHolder>{
    ...
    private List<SubPartyCompleteInfo.Summary>  SummaryList,filterSummaryList;
    private SubPartyCompleteInfo.SalesInfo SalesInfo;
    private List<SubPartyCompleteInfo.GroupWise>  GroupWiseList,filterGroupWiseList;
    private List<SubPartyCompleteInfo.PartyMonthWiseSale>  PartyMonthWiseList,filterPartyMonthWiseList;
    //private List<SubPartyCompleteInfo.ShowroomWiseSale>  ShowroomWiseList,filterShowroomWiseList;
    ...
    private List<SubPartyCompleteInfo.FairDeliveryParcent>  FairDeliveryParcentList,filterFairDeliveryParcentList;
    private static String TAG = SubPartyCommonDetailsListAdapter.class.getSimpleName();
    public static Map<String,String> mapAvgPayDays = new HashMap<>();
    public static Map<String,String> mapDiscount = new HashMap<>();
    public SubPartyCommonDetailsListAdapter(Context context, String Title , SubPartyCompleteInfo.SalesInfo SalesInfo) {
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
        ...
        if (Title.equals("Summary")){
            SubPartyCompleteInfo.Summary dataset = filterSummaryList.get(position);
            //holder.cardView.setTag(dataset.get());
            //TODO: call TableLayout method
            setTableLayoutSummary(filterSummaryList,holder.tableLayout);
        }else if (Title.equals("Group Wise Sales")){
            SubPartyCompleteInfo.GroupWise dataset = filterGroupWiseList.get(position);
            holder.cardView.setTag(dataset.getGroupID());
            //TODO: call TableLayout method
            setTableLayout(filterGroupWiseList,holder.tableLayout);
        }else if (Title.equals("Party Month Wise Sales")){
            SubPartyCompleteInfo.PartyMonthWiseSale dataset = filterPartyMonthWiseList.get(position);
            //holder.cardView.setTag(dataset.get());
            //TODO: call TableLayout method
            ...
            SubPartyCompleteInfo.FairDeliveryParcent dataset = filterFairDeliveryParcentList.get(position);
            //holder.cardView.setTag(dataset.get());
            //TODO: call TableLayout method
            ...
            public void run() {
                ...
                if (Title.equals("Summary")){
                    ...
                    if (TextUtils.isEmpty(text)) {
                        ...
                        for (SubPartyCompleteInfo.Summary item : SummaryList) {
//                            if(item.get()!=null)
...
//                                }
                    ...
                    if (TextUtils.isEmpty(text)) {
                        ...
                        // Iterate in the original List and add it to filter list...
                        for (SubPartyCompleteInfo.GroupWise item : GroupWiseList) {
                    ...
                    if (TextUtils.isEmpty(text)) {
                        ...
                        // Iterate in the original List and add it to filter list...
                        for (SubPartyCompleteInfo.PartyMonthWiseSale item : PartyMonthWiseList) {
                    ...
                    if (TextUtils.isEmpty(text)) {
                        ...
                        // Iterate in the original List and add it to filter list...
                        for (SubPartyCompleteInfo.FairDeliveryParcent item : FairDeliveryParcentList) {
    ...
    private void setTableLayoutSummary(List<SubPartyCompleteInfo.Summary> list, TableLayout tableLayout){
    ...
    //TODO: Display Group Wise TableLayout
    private void setTableLayout(List<SubPartyCompleteInfo.GroupWise> list, TableLayout tableLayout){

        List<Map<String,String>> groupList = new ArrayList<>();
        for (int i=0; i<list.size(); i++){
            if (groupList.isEmpty()) {
                Map<String, String> map = new HashMap<>();
                map.put("GroupName", list.get(i).getGroupName());
                map.put("Year1", list.get(i).getSaleQtyGroupWise0() + " / ₹" + list.get(i).getSaleAmtGroupWise0());
                map.put("Year2", list.get(i).getSaleQtyGroupWise1() + " / ₹" + list.get(i).getSaleAmtGroupWise1());
                map.put("Year3", list.get(i).getSaleQtyGroupWise2() + " / ₹" + list.get(i).getSaleAmtGroupWise2());
                groupList.add(map);
            }else{
                int c=0;
                String GroupName = list.get(i).getGroupName();
                for (int x=0; x<groupList.size(); x++) {
                    if (GroupName.equals(groupList.get(x).get("GroupName"))){
                        c = 1;
                        break;
                    }
                }
        ...
        for (int j=0; j<groupList.size(); j++) {
            ...
            txt = new TextView(context);
            txt.setId(j + 300);
            txt.setText("" + groupList.get(j).get("Year1"));
            txt.setBackground(context.getResources().getDrawable(R.drawable.cell_border));
            txt.setTextColor(Color.BLACK);
            txt.setGravity(Gravity.CENTER_HORIZONTAL);
            txt.setPadding(10, 10, 10, 10);
            ...
            txt = new TextView(context);
            txt.setId(j + 400);
            txt.setText("" + groupList.get(j).get("Year2"));
            txt.setBackground(context.getResources().getDrawable(R.drawable.cell_border));
            txt.setTextColor(Color.BLACK);
            txt.setGravity(Gravity.CENTER_HORIZONTAL);
            txt.setPadding(10, 10, 10, 10);
            ...
            txt = new TextView(context);
            txt.setId(j + 500);
            txt.setText("" + groupList.get(j).get("Year3"));
            txt.setBackground(context.getResources().getDrawable(R.drawable.cell_border));
            txt.setTextColor(Color.BLACK);
            txt.setGravity(Gravity.CENTER_HORIZONTAL);
            txt.setPadding(10, 10, 10, 10);
...
//        txt.setText(""+(dataset.getGroupName()==null?"":dataset.getGroupName()));
...
//        txtHeader1.setText("Sale Amount 1:");
//
//        TextView txt1= (TextView) v1.findViewById(R.id.content);
//        txt1.setText(""+(dataset.getSaleAmtGroupWise0()==null?"":"₹"+dataset.getSaleAmtGroupWise0()));
...
//        txtHeader2.setText("Sale Amount 2:");
//
//        TextView txt2= (TextView) v2.findViewById(R.id.content);
//        txt2.setText(""+(dataset.getSaleAmtGroupWise1()==null?"":"₹"+dataset.getSaleAmtGroupWise1()));
...
//        txtHeader3.setText("Sale Amount 3:");
//
//        TextView txt3= (TextView) v3.findViewById(R.id.content);
//        txt3.setText(""+(dataset.getSaleAmtGroupWise2()==null?"":"₹"+dataset.getSaleAmtGroupWise2()));
...
//        txtHeader4.setText("Sale Quantity 1:");
//
//        TextView txt4= (TextView) v4.findViewById(R.id.content);
//        txt4.setText(""+(dataset.getSaleQtyGroupWise0()==null?"":dataset.getSaleQtyGroupWise0()));
...
//        txtHeader5.setText("Sale Quantity 2:");
//
//        TextView txt5= (TextView) v5.findViewById(R.id.content);
//        txt5.setText(""+(dataset.getSaleQtyGroupWise1()==null?"":dataset.getSaleQtyGroupWise1()));
...
//        txtHeader6.setText("Sale Quantity 3:");
//
//        TextView txt6= (TextView) v6.findViewById(R.id.content);
//        txt6.setText(""+(dataset.getSaleQtyGroupWise2()==null?"":dataset.getSaleQtyGroupWise2()));
//        tableLayout.addView(v6);
    }
    //TODO: Display Party Month Wise TableLayout
    private void setTableLayoutPartyMonthWise(List<SubPartyCompleteInfo.PartyMonthWiseSale> list, TableLayout tableLayout){
...
//        tableLayout.addView(v4);
    ...
    private void setTableLayoutFairDeliveryPercent(SubPartyCompleteInfo.FairDeliveryParcent dataset, TableLayout tableLayout){
