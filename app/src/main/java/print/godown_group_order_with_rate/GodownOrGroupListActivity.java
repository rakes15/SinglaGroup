...
import print.godown_group_order_with_rate.adapter.GroupOrGodownAdapter;
 ...
 */
public class GodownOrGroupListActivity extends AppCompatActivity{
    ...
    private GroupOrGodownAdapter adapter;
    private List<GroupOrGodown> groupOrGodownList;
    private Order order;
    private static String TAG = GodownOrGroupListActivity.class.getSimpleName();
    @Override
    ...
    private void Initialization(){
        ...
        this.context = GodownOrGroupListActivity.this;
        ...
        //GroupOrGodownAdapter.listGroup = new ArrayList<>();
    }
    private void GetIntent(){
        try {
            order = (Order) getIntent().getExtras().get("Key");
            int GroupOrGodown = getIntent().getExtras().getInt("GroupOrGodown");
            //GroupOrGodownAdapter.listGroup = new ArrayList<>();
...
//                if (GroupOrGodownAdapter.listGroup!=null && !GroupOrGodownAdapter.listGroup.isEmpty()){
//                    Intent intent = new Intent(context,PrintActivity.class);
//                    intent.putExtra("Key",GroupOrGodownAdapter.listGroup.get(0));
//                    intent.putExtra("Order",order);
//                    startActivity(intent);
//                }else{
//                    Intent intent = new Intent(context,PrintActivity.class);
//                    intent.putExtra("Key",groupOrGodownList.get(0));
//                    intent.putExtra("Order",order);
//                    startActivity(intent);
//                }
                break;
...
//        searchView.setOnQueryTextListener(textChangeListener);
    ...
    private void LoadRecyclerView(List<GroupOrGodown> groupOrGodownList){
        this.groupOrGodownList = groupOrGodownList;
        adapter = new GroupOrGodownAdapter(context,groupOrGodownList);
        ...
        ItemClickSupport.addTo(recyclerView).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                GroupOrGodown groupOrGodown = (GroupOrGodown) adapter.getItem(position);
                Intent intent = new Intent(context, GodownOrGroupListActivity1.class);
