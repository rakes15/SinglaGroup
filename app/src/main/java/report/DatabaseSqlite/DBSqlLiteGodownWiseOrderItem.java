...
public class DBSqlLiteGodownWiseOrderItem extends SQLiteOpenHelper {
    ...
    public DBSqlLiteGodownWiseOrderItem(Context context) {
    ...
    //TODO:-------------------------------            Order Wise                ---------------------------------------
    public List<OrderWise> getDocumentWise(){
        ...
        if(cursor.getCount()>0){
            ...
            do {
                ...
                Map<String,Integer> map = getCountDocumentWise(OrderID);
                int pendingItems = map.get("TotalItems");
                int pendingQty = map.get("TotalPendingQty");
    ...
    public Map<String,Integer> getCountDocumentWise(String OrderID){
        Map<String,Integer> map=new HashMap<>();
        // Select All Query
    ...
    public Map<String,Integer> getCountGroupByDocumentWise(String GroupID,String OrderID){
        Map<String,Integer> map=new HashMap<>();
        // Select All Query
    ...
    public List<GroupWise> getGroupListByDocumentWise(String OrderID){
        List<GroupWise> dataList = new ArrayList<>();
        // Select All Query
        ...
        if(cursor.getCount()>0){
            cursor.moveToFirst();
            do {
                Map<String,Integer> map = getCountGroupByDocumentWise(cursor.getString(cursor.getColumnIndex(REPORT_GROUP_ID)),cursor.getString(cursor.getColumnIndex(REPORT_ORDER_ID)));
                int PendingItems = map.get("TotalItems");
                int PendingQty = map.get("TotalPendingQty");
                dataList.add(new GroupWise(cursor.getString(cursor.getColumnIndex(REPORT_GROUP_ID))
                        ,cursor.getString(cursor.getColumnIndex(REPORT_GROUP_NAME))
    ...
    public List<ItemDetails> getItemListByDocumentWise(String GroupID, String OrderID){
        List<ItemDetails> dataList = new ArrayList<>();
        // Select All Query
        ...
        return dataList;
            ...
            public List<Map<String,String>> getSizeListByDocumentWise(String ItemID,String GroupID,String OrderID){
                List<Map<String,String>> dataList=new ArrayList<Map<String,String>>();
                // Select All Query
            ...
            public List<Map<String,String>> getColorListByDocumentWise(String ItemID,String GroupID,String OrderID){
                List<Map<String,String>> dataList=new ArrayList<Map<String,String>>();
                // Select All Query
            ...
            public Map<String, Integer> getPendingOrderStockQtyByDocumentWise(String SizeID,String ColorID,String ItemID,String GroupID,String OrderID){
                Map<String, Integer> map = new HashMap<>();
                // Select All Query
            ...
            public List<Map<String,String>> getPriceListByDocumentWise(String ItemID,String GroupID,String OrderID){
                List<Map<String,String>> dataList =null;
                dataList=new ArrayList<Map<String,String>>();
                // Select All Query
            ...
            public Map<String,Integer> getWithoutSubItemDetailsByDocumentWise(String ItemID,String GroupID,String OrderID){
                Map<String,Integer>  map=new HashMap<>();
                // Select All Query
            ...
            public List<Map<String,String>> getSubItemDetailsByDocumentWise(String ItemID,String GroupID,String OrderID){
                List<Map<String,String>> dataList = new ArrayList<>();
                // Select All Query
            ...
            public Map<String,Integer> getSubItemStockDetailsByDocumentWise(String ItemID,String SubItemID,String GroupID,String OrderID){
                Map<String,Integer> map=new HashMap<>();
                // Select All Query
    ...
    public ArrayList<HashMap<String,String>> getDocumentWiseCustomerNameWithTotalQty(String OrderNo,String ItemCode){
