...
public class DBSqlLitePendingDispatch extends SQLiteOpenHelper {
    //TODO:--------------------- Database Version----------------------
    private static final int DATABASE_VERSION = 1;
 
    // -----------------------Database Name--------------
    public static final String DATABASE_NAME = "SinglaGroups_PendingDispatch";
 
    //TODO:--------------------------Table Name--------------------------------------------------------------
    private static final String REPORT_TABLE = "reportTbl";   
    private static final String REPORT_TABLE2 = "reportTbl2";   
    ...
    public DBSqlLitePendingDispatch(Context context) {
    ...
    public void insertPendingVsDispatchTable(List<Map<String,String>> list) {
    ...
    public List<ItemDetails> getItemListByGroupWise(String GroupID,int sortFlag){
        ...
        String selectQuery = "";
        if (sortFlag == 0) {
            selectQuery = "SELECT DISTINCT " + REPORT_ITEM_ID+","+REPORT_ITEM_NAME+","+REPORT_ITEM_CODE+","+REPORT_SUB_ITEM_ID+","+REPORT_SUB_ITEM_NAME+","+REPORT_GROUP_ID+","+REPORT_GROUP_NAME+","+REPORT_MAIN_GROUP_NAME+"," + REPORT_MD_APPLICABLE + "," + REPORT_SUBITEM_APPLICABLE + " from " + REPORT_TABLE + " WHERE " + REPORT_GROUP_ID + "='" + GroupID + "' Order BY  " + REPORT_ITEM_CODE + " ASC ";
        }else if (sortFlag == 1){
    ...
    public List<ItemDetails> getItemAllDetailsByItem(String ItemID){
        List<ItemDetails> dataList = new ArrayList<>();
        // Select All Query
        String selectQuery = "SELECT DISTINCT " + REPORT_ITEM_ID+","+REPORT_ITEM_NAME+","+REPORT_ITEM_CODE+","+REPORT_SUB_ITEM_ID+","+REPORT_SUB_ITEM_NAME+","+REPORT_GROUP_ID+","+REPORT_GROUP_NAME+","+REPORT_MAIN_GROUP_NAME+"," + REPORT_MD_APPLICABLE + "," + REPORT_SUBITEM_APPLICABLE + "," + REPORT_PARTY_ID + "," + REPORT_PARTY_NAME + "," + REPORT_SUB_PARTY_ID + "," + REPORT_SUB_PARTY_NAME + "," + REPORT_REFRENCE_NAME + "," + REPORT_ORDER_ID + "," + REPORT_ORDER_NO + "," + REPORT_ORDER_DATE + " from " + REPORT_TABLE + " WHERE " + REPORT_ITEM_ID + "='" + ItemID + "' Order BY  " + REPORT_ORDER_DATE + " DESC ";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery,null);
        // looping through all rows and adding to list
        if(cursor.getCount()>0){
            ...
            do {
                dataList.add(new ItemDetails(cursor.getString(cursor.getColumnIndex(REPORT_ITEM_ID))
                        ...
                        ,cursor.getInt(cursor.getColumnIndex(REPORT_MD_APPLICABLE))
                        ,cursor.getInt(cursor.getColumnIndex(REPORT_SUBITEM_APPLICABLE))
                        ,cursor.getString(cursor.getColumnIndex(REPORT_SUB_PARTY_ID))  //SubParty ID
                        ,cursor.getString(cursor.getColumnIndex(REPORT_SUB_PARTY_NAME))     //SubParty Name
                        ,cursor.getString(cursor.getColumnIndex(REPORT_REFRENCE_NAME))       //Reference Name
                ));
            } while (cursor.moveToNext());
            // closing connection
            cursor.close();
        ...
        return dataList;
            ...
            public Map<String,Float> getSubItemStockDetailsByGroupWise(String ItemID,String SubItemID,String GroupID){
                ...
                {
                    cursor.moveToFirst();
                    map.put("PendingQry", cursor.getFloat(cursor.getColumnIndex("PendingQty")));
                    map.put("BookedQty", cursor.getFloat(cursor.getColumnIndex("OrderQty")));
                    map.put("SubItemStock", cursor.getFloat(cursor.getColumnIndex("SubItemStock")));
                    // closing connection
                    cursor.close();
                    db.close();
                }
    ...
    public List<GroupWise> getGroupListByPartyWise(String PartyID,String SubPartyID,String RefName){
        ...
        String selectQuery = "";
        if (!SubPartyID.isEmpty()) {
            selectQuery = "SELECT DISTINCT "+REPORT_GROUP_ID+","+REPORT_GROUP_NAME+","+REPORT_MAIN_GROUP_ID+","+REPORT_MAIN_GROUP_NAME+","+REPORT_PARTY_ID+","+REPORT_PARTY_NAME+","+REPORT_SUB_PARTY_ID+","+REPORT_SUB_PARTY_NAME+","+REPORT_REFRENCE_NAME+" from " + REPORT_TABLE + " WHERE "+ REPORT_PARTY_ID + "='"+PartyID+"' AND " + REPORT_SUB_PARTY_ID + "='" + SubPartyID + "'";
        }else if (!RefName.isEmpty()) {
            selectQuery = "SELECT DISTINCT "+REPORT_GROUP_ID+","+REPORT_GROUP_NAME+","+REPORT_MAIN_GROUP_ID+","+REPORT_MAIN_GROUP_NAME+","+REPORT_PARTY_ID+","+REPORT_PARTY_NAME+","+REPORT_SUB_PARTY_ID+","+REPORT_SUB_PARTY_NAME+","+REPORT_REFRENCE_NAME+" from " + REPORT_TABLE + " WHERE "+ REPORT_PARTY_ID + "='"+PartyID+"' AND " + REPORT_REFRENCE_NAME + "='" + RefName + "'";
        } else {
            selectQuery = "SELECT DISTINCT "+REPORT_GROUP_ID+","+REPORT_GROUP_NAME+","+REPORT_MAIN_GROUP_ID+","+REPORT_MAIN_GROUP_NAME+","+REPORT_PARTY_ID+","+REPORT_PARTY_NAME+","+REPORT_SUB_PARTY_ID+","+REPORT_SUB_PARTY_NAME+","+REPORT_REFRENCE_NAME+" from " + REPORT_TABLE + " WHERE "+ REPORT_PARTY_ID + "='"+PartyID+"' ";
        }
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery(selectQuery,null);
        // looping through all rows and adding to list
    ...
    public List<ItemDetails> getItemListByPartyWise(String GroupID,String PartyID,String SubPartyID,String RefName){
        ...
        return dataList;
            ...
            public List<Map<String,String>> getPriceListByPartyWise(String ItemID,String GroupID,String PartyID,String SubPartyID,String RefName){
                ...
                String selectQuery = "";
                if (!SubPartyID.isEmpty()) {
                    selectQuery = "SELECT DISTINCT "+REPORT_RATE+"  from " + REPORT_TABLE+ " where "+REPORT_ITEM_ID+"='"+ItemID+"' AND "+REPORT_GROUP_ID+"='"+GroupID+"' AND "+REPORT_PARTY_ID+"= '"+PartyID+"' AND " + REPORT_SUB_PARTY_ID + "='" + SubPartyID + "'  AND "+REPORT_COLOR_SIZE_BOOKED_QTY+"> 0";
                }else if (!RefName.isEmpty()) {
                    selectQuery = "SELECT DISTINCT "+REPORT_RATE+"  from " + REPORT_TABLE+ " where "+REPORT_ITEM_ID+"='"+ItemID+"' AND "+REPORT_GROUP_ID+"='"+GroupID+"' AND "+REPORT_PARTY_ID+"= '"+PartyID+"' AND " + REPORT_REFRENCE_NAME + "='" + RefName + "'  AND "+REPORT_COLOR_SIZE_BOOKED_QTY+"> 0";
                } else {
                    selectQuery = "SELECT DISTINCT "+REPORT_RATE+"  from " + REPORT_TABLE+ " where "+REPORT_ITEM_ID+"='"+ItemID+"' AND "+REPORT_GROUP_ID+"='"+GroupID+"' AND "+REPORT_PARTY_ID+"= '"+PartyID+"'  AND "+REPORT_COLOR_SIZE_BOOKED_QTY+"> 0";
                }
                SQLiteDatabase db = this.getReadableDatabase();
                Cursor cursor = db.rawQuery(selectQuery,null);
                // looping through all rows and adding to list
            ...
            public Map<String,Float> getSubItemStockDetailsByPartyWise(String ItemID,String SubItemID,String GroupID,String PartyID,String SubPartyID,String RefName){
                ...
                String selectQuery = "";
                if (!SubPartyID.isEmpty()) {
                    selectQuery = "SELECT SUM("+REPORT_SUB_ITEM_STOCK+") as PendingQty,SUM("+REPORT_OrderQty+") as OrderQty,SUM("+REPORT_SUB_ITEM_STOCK+") as SubItemStock from " + REPORT_TABLE+" WHERE "+REPORT_ITEM_ID+"='"+ItemID+"' AND "+REPORT_SUB_ITEM_ID+"='"+SubItemID+"' AND "+REPORT_GROUP_ID+"='"+GroupID+"' AND "+REPORT_PARTY_ID+"='"+PartyID+"'  AND " + REPORT_SUB_PARTY_ID + "='" + SubPartyID + "'";
                }else if (!RefName.isEmpty()) {
                    selectQuery = "SELECT SUM("+REPORT_SUB_ITEM_STOCK+") as PendingQty,SUM("+REPORT_OrderQty+") as OrderQty,SUM("+REPORT_SUB_ITEM_STOCK+") as SubItemStock from " + REPORT_TABLE+" WHERE "+REPORT_ITEM_ID+"='"+ItemID+"' AND "+REPORT_SUB_ITEM_ID+"='"+SubItemID+"' AND "+REPORT_GROUP_ID+"='"+GroupID+"' AND "+REPORT_PARTY_ID+"='"+PartyID+"'   AND " + REPORT_REFRENCE_NAME + "='" + RefName + "'";
                } else {
                    selectQuery = "SELECT SUM("+REPORT_SUB_ITEM_STOCK+") as PendingQty,SUM("+REPORT_OrderQty+") as OrderQty,SUM("+REPORT_SUB_ITEM_STOCK+") as SubItemStock from " + REPORT_TABLE+" WHERE "+REPORT_ITEM_ID+"='"+ItemID+"' AND "+REPORT_SUB_ITEM_ID+"='"+SubItemID+"' AND "+REPORT_GROUP_ID+"='"+GroupID+"' AND "+REPORT_PARTY_ID+"='"+PartyID+"' ";
                }
                SQLiteDatabase db = this.getReadableDatabase();
                Cursor cursor = db.rawQuery(selectQuery,null);
                // looping through all rows and adding to list
