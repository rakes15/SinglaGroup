...
public class ItemDetails implements Serializable {
    ...
    String VType,ItemID,ItemName,ItemCode,SubItemID,SubItemName,SubItemCode,GroupID,GroupName,MainGroup,PartyID,PartyName,OrderID,OrderDate,OrderNo,SubPartyID,SubPartyName,RefName;
    int MDApplicable,SubItemApplicable;

    public ItemDetails(String VType,String ItemID, String ItemName, String ItemCode, String SubItemID, String SubItemName,String SubItemCode, String GroupID, String GroupName, String MainGroup, String PartyID, String PartyName, String OrderID, String OrderDate, String OrderNo, int MDApplicable, int SubItemApplicable,String SubPartyID,String SubPartyName,String RefName) {
        this.VType = VType;
        this.ItemID = ItemID;
