...
public class GroupListByPartyOrOrderWiseActivity extends AppCompatActivity {
    ...
    private void GetIntentMethod(){
        try {
            ...
            if(partyWise!=null) {
                ...
                LoadRecyclerView(partyWise.getPartyID(),"");

            }else if (orderWise !=null) {

                actionBar.setTitle(""+ orderWise.getOrderNo());
                LoadRecyclerView("", orderWise.getOrderID());
    ...
    private void LoadRecyclerView(String PartyID,String OrderID){
        //TODO: Load Recycler View
        if (!PartyID.isEmpty() || PartyID!=null) {
            adapter = new GroupWiseAdapter(context,DBHandler.getGroupListByPartyWise(PartyID));
            ...
            adapter = new GroupWiseAdapter(context,DBHandler.getGroupListByDocumentWise(OrderID));
            recyclerView.setAdapter(adapter);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context);
            linearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
            recyclerView.setLayoutManager(linearLayoutManager);
