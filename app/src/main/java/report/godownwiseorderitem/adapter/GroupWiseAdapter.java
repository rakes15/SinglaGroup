 ...
 */
public class GroupWiseAdapter extends RecyclerView.Adapter<GroupWiseAdapter.RecyclerViewHolder>{

    private Context context;
    private ProgressDialog progressDialog;
    private LayoutInflater inflater;
    private List<GroupWise> datasetList,filterDatasetList;
    private static String TAG = GroupWiseAdapter.class.getSimpleName();
    public GroupWiseAdapter(Context context, List<GroupWise> datasetList) {
        this.context=context;
        this.datasetList=datasetList;
        this.filterDatasetList = new ArrayList<GroupWise>();
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, final int position) {
        ...
        final GroupWise dataset = filterDatasetList.get(position);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (TextUtils.isEmpty(text)) {
                    ...
                    for (GroupWise item : datasetList) {
    ...
    private void setTableLayout(GroupWise dataset, TableLayout tableLayout, TableLayout tableLayout2){
