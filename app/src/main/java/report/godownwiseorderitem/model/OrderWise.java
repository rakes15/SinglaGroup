...
public class OrderWise implements Serializable {
    ...
    public OrderWise(String OrderID, String OrderNo, String OrderDate, String OrderStatus, String OrderTypeName, String UrgencyLevel, String Showroom, String ExpectedDelDate, String PartyID, String PartyName, String SubPartyID, String SubParty, String RefName, String PendingSince, int PendingItems, int PendingQty, int OrderQty, int PendingPercentage) {
