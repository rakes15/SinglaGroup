...
import report.pendingdispatch.adapter.ItemAllDetailsByItemAdapter;
import report.pendingdispatch.adapter.ItemDetailsAdapter;
...
public class ItemAllDetailsByItemActivity extends AppCompatActivity {
    ActionBar actionBar;
    private Context context;
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView recyclerView;
    private ItemAllDetailsByItemAdapter adapter;
    private ProgressDialog progressDialog;
    private int sort=0;
    private String GroupID="",PartyID="",OrderID="";
    private DBSqlLitePendingDispatch DBHandler;
    private static String TAG = ItemAllDetailsByItemActivity.class.getSimpleName();
    @Override
    ...
    private void Initialization(){
        this.context = ItemAllDetailsByItemActivity.this;
    ...
    private void GetIntentMethod(){
        try {
            ItemDetails itemDetails = (ItemDetails) getIntent().getExtras().get("Key");
            if(itemDetails!=null) {
                actionBar.setTitle("" + itemDetails.getItemCode());
                LoadRecyclerView(itemDetails.getItemID());
            }else {
    ...
    private void LoadRecyclerView(String ItemID){
        //TODO: Load Recycler View
        if (!ItemID.isEmpty()) {
            adapter = new ItemAllDetailsByItemAdapter(context,DBHandler.getItemAllDetailsByItem(ItemID));
