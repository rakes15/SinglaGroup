...
public class OrderWiseAdapter extends RecyclerView.Adapter<OrderWiseAdapter.RecyclerViewHolder>{
    ...
    private void setTableLayout(OrderWise dataset, TableLayout tableLayout, TableLayout tableLayout2) {
        ...
        //TODO: Pending Since
        v = inflater.inflate(R.layout.table_row, tableLayout, false);
        tableLayout.addView(CustomTextView.setTableRow2Columns(context, v, "Pending Since", (dataset.getPendingSince() == null || dataset.getPendingSince().equals("null") ? "" : dataset.getPendingSince())));
        //TODO: Showroom
        v = inflater.inflate(R.layout.table_row, tableLayout, false);
        ...
        txtContent2.setText("Pending Qty : "+dataset.getPendingQty()+"("+dataset.getPendingPercentage()+"%)");
