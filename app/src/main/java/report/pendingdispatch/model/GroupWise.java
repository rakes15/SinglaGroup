...
public class GroupWise implements Serializable {
    ...
    String GroupID,GroupName,MainGroupID,MainGroup,PartyID,PartyName,OrderID,OrderNo,SubPartyID,SubPartyName,RefName;
    int PendingItems,PendingQty;

    public GroupWise(String GroupID, String GroupName, String MainGroupID, String MainGroup, int PendingItems, int PendingQty,String PartyID,String PartyName,String OrderID,String OrderNo,String SubPartyID,String SubPartyName,String RefName) {
