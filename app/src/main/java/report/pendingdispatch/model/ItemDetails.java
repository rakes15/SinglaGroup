...
public class ItemDetails implements Serializable {
    ...
    String SubPartyID,SubPartyName,RefName;
    int MDApplicable,SubItemApplicable;

    public ItemDetails(String ItemID, String ItemName, String ItemCode, String SubItemID, String SubItemName,String SubItemCode, String GroupID, String GroupName, String MainGroup, String PartyID, String PartyName, String OrderID, String OrderDate, String OrderNo, int MDApplicable, int SubItemApplicable, String SubPartyID, String SubPartyName,String RefName) {
        this.ItemID = ItemID;
