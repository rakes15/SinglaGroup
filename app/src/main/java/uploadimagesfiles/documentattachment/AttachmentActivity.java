...
import uploadimagesfiles.documentattachment.adapter.RecyclerViewAttachedListAdapter;
...
public class AttachmentActivity extends AppCompatActivity {
    ...
    private Result voucherDocumentDataset;
    @Override
    ...
    private void GetIntentMethod(){
        try {
            ...
            if (Type.equals("0") && !Type.isEmpty()) {
                voucherDocumentDataset = (Result) getIntent().getExtras().get("VoucherDataset");
...
//            LoadRecyclerView(voucherDocumentDataset, masterDocumentDataset, Type);
    ...
    private void LoadRecyclerView(Result voucherDocumentDataset, String Type){
...
//                System.out.println("on query submit: "+query);
    ...
    private void CallRetrofitSearchFilter(String DeviceID, String SessionID, String UserID, String BranchID, String DivisionID, String CompanyID, String GodownID, String VType, String FromDate, String ToDate, final String Type){
        ...
        if (Type.equals("0")) {
            Call<ResponseDocumentDataset> call = null;//apiService.getDocAttachVoucherList(params);
